...
void init_IDT() {
    ...
    set_IDT_entry(40, &timer_isr, 0x8E, IDT);
    ...
    set_IDT_entry(4, &overflowException, 0x8E, IDT);
    set_IDT_entry(5, &boundRangeExceededException, 0x8E, IDT);
    set_IDT_entry(6, &invalidOpcodeException, 0x8E, IDT);
    set_IDT_entry(7, &deviceNotAvaliableException, 0x8E, IDT);
    set_IDT_entry(8, &doubleFaultException, 0x8E, IDT);
    set_IDT_entry(9, &coprocessorSegmentOverrunException, 0x8E, IDT);
    set_IDT_entry(10, &invalidTSSException, 0x8E, IDT);
    set_IDT_entry(11, &segmentNotPresentException, 0x8E, IDT);
    set_IDT_entry(12, &stackSegmentFaultException, 0x8E, IDT);
    set_IDT_entry(13, &generalProtectionFaultException, 0x8E, IDT);
    set_IDT_entry(14, &pageFaultException, 0x8E, IDT);
    set_IDT_entry(16, &floatingPointException, 0x8E, IDT);
    set_IDT_entry(17, &alignmentCheckException, 0x8E, IDT);
    set_IDT_entry(18, &machineCheckException, 0x8E, IDT);
    set_IDT_entry(19, &simdFloatingPointException, 0x8E, IDT);
    set_IDT_entry(20, &virtualisationException, 0x8E, IDT);
